...
void initializeContour(unsigned int& VAO, unsigned int& VBO, unsigned int& EBO, float movement);
...
int main()
{
    ...
    // ------------------------------------------------------------------
    unsigned int VAO1 =0, VBO1 =0, EBO1 = 0;

    initializeContour(VAO1, VBO1, EBO1, 0.5);
